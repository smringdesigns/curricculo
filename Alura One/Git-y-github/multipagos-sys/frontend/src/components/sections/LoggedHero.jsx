    ...
    const fetchUserInfo = async () => {
      try {
        ...
        const response = await axios.get(
          "http://localhost:9999/api/users/user-info",
          {
            headers: {
      ...
      <div className="container">
        <div className="row gy-md-0 gy-4">
          <div className="col-lg-6 col-md-6">
            <div
              className="d-flex justify-content-center flex-column h-100 py-lg-2 text-md-start text-center"
              data-aos="fade-right"
            >
              <h1>Bienvenido {username} a Multipagos</h1>
              <p>{description}</p>
              <div>
